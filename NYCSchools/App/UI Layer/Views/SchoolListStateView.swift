...
//  NYCSchools
//
//  Created by Wout Salembier on 21/12/2023.
//
...
class SchoolListStateView: UIView {
    ...
    func update(for state: SchoolLoadState) {
        ...
        case .loaded:
            break
        case .empty:
            headerLabel.text = "school.loading.empty.title".localized()
            messageLabel.text = "school.loading.empty.description".localized()
